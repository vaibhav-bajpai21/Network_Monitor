...
paste tcp_time tcp_srcadd tcp_dstadd tcp_length tcp_srcport tcp_dstport tcp_srcmac tcp_dstmac > tcpall
...
paste arp_time arp_srcmac arp_dstmac arp_srcadd arp_dstadd arp_length > arpall
...
paste udp_time udp_srcmac udp_dstmac udp_srcadd udp_dstadd udp_length udp_srcport udp_dstport > udpall
